...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    /**
     * Конвертация картинки в файл
     * @param null $photo контент картинки (тело)
     * @param string|null $path абсолютный путь сохранения картинки
     * @return bool
     */
    public function convertBase64ToImage($photo = null, string $path = null)
    {
        if (!empty($photo)) {
