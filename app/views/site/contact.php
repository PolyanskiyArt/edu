...
<div class="site-contact">
	...
	<?php else: ?>
		...
		<p>
            Если у вас есть вопросы или предложения - заполните поля, мы обязательно прочитаем и постараемся ответить
        </p>
		...
		<div class="row">
			<div class="col-lg-5">
				...
				<?= $form->field($model, 'verifyCode')->label('Код')->widget(Captcha::class, [
